...
export default function Skills() {
  ...
  return (
    <motion.div
      ...
      className="group relative mx-4 my-6 w-full cursor-pointer overflow-hidden rounded-2xl border border-white/30 bg-[#1D1928] p-5 sm:mx-6 lg:mr-4 lg:ml-0 lg:h-[400px] lg:w-[30%]"
    >
      {/* GREEN BORDER */}
      <div
